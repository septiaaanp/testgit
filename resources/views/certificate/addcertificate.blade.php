          ...
          <div class="col-md-12">
            ...
            <div class="card card-default">
              <div class="card-header">
                ...
                @endif
                <!-- form start -->
                <form role="form" method="post" action="/addcertificate/process" enctype="multipart/form-data">
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" placeholder="Nama Certificate" name="certificate" class="form-control" required>
                    </div>
                    <div class="form-group col-md-12">
                        <label for="">Nama Penerbit</label>
                        <input type="text" placeholder="Nama Certificate" name="penerbit" class="form-control" required>
                    </div>
                    <div class="col-md-3">
