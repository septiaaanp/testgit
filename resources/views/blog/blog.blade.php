        ...
        @endif
		  <div class="row">
		    ...
		    <div class="col-md-8">
		      ...
		      <div class="card mb-4">
		        <img class="card-img-top" src="{{ url('/assets/images/image_1.jpg') }}" alt="Card image cap">
		        <div class="card-body">
		          <h2 class="card-title"><a href="{{ route('show', $post->slug) }}">{{ $post->title }}</a></h2>
		          <p class="card-text">{!! str_limit($post->excerpt_html, $limit = 150, $end = '...') !!}</p>
		          <a href="{{ route('show', $post->slug) }}" class="btn btn-primary">Read More &rarr;</a>
		        </div>
		        <div class="card-footer text-muted">
		          Posted on {{ $post->published_at->format('M. d, Y') }} by
  		    ...
  		    <div class="card my-4">
    			  ...
    			  <div>
    			    <ul class="list-group list-group-flush">
    			      ...
    			      <li class="list-group-item"><img src="{{ $popularPost->image_thumb_url }}" width=35% alt=""><a href="{{ route('show', $popularPost->slug)}}">&nbsp;{{ substr($popularPost->title, 0, 20) }} ...<span class="badge badge-pill badge-secondary float-right">{{ $popularPost->view_count }} {{ str_plural('view', $popularPost->view_count)}}</span></a></li>
    			      @endforeach
    			    </ul>
    			  </div>
  			  </div>
