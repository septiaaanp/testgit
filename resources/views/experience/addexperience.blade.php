...
function myFunction() {
  ...
  if (checkBox.checked == true){
    text.style.display = "none"; //none ga muncul
    text1.style.display = "none"; 
    text2.style.display = "block"; // block muncul
  } else {
          ...
          <div class="col-md-12">
            ...
            <div class="card card-default">
              <div class="card-header">
                ...
                @endif
                <!-- form start -->
                <form role="form" method="post" action="/addexperience/process" enctype="multipart/form-data">
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" placeholder="Nama Perusahaan" name="perusahaan" class="form-control" required>
                    </div>
                    <div class="form-group col-md-12">
                      Ini adalah posisi saya saat ini: <input type="checkbox" name="checkbox" id="myCheck" onclick="myFunction()" value="1">
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-control" name="bulan_masuk" required>
                            <option value="" class="text-muted">Pilih Bulan Masuk</option>
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-control" name="tahun_masuk" required>
                            <option value="" class="text-muted">Pilih Tahun Masuk</option>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" placeholder="Posisi" name="posisi" class="form-control" required>
                    </div>
                    <div class="form-group col-md-12">
